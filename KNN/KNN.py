...
class ImageClassifierApp(QWidget):
    def __init__(self):
        super().__init__()
        self.initUI()
        self.model = joblib.load("KNN_object_detection.pkl")
    ...
    def upload_image(self):
        ...
        if file_name:
            ...
            # Green bounding box at the center for water body
            if has_water:
            ...
            # Red bounding box at the top left for vegetation
            if has_vegetation:
...
def extract_hog_features(image):
    ...
    water_bbox = get_combined_bounding_box(mask_blue)
